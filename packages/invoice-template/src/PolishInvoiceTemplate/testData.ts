import { PolishInvoiceHeader, PolishInvoiceTableItem, PolishInvoiceTax, PolishInvoiceTotal } from "."
import { SellerBuyerData } from ".."

const header: PolishInvoiceHeader = {
  dateFormat: "yyyy-MM-d",
  documentDate: new Date("2022-01-20"),
  sellDate: new Date("2022-01-21"),
  dueDate: new Date("2022-01-21"),
...
export const polishInvoiceTestProps = {
  header,
  seller,
  buyer,
  itemsTable,
